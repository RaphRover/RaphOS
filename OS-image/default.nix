...
let
  ...
  ibis_ui = buildNpmPackage {
    ...
    src = builtins.fetchGit {
      ...
      rev = "aa164ca0bcd34eebdef2688712ee73cf004c002c";
    };
  ...
  packageLists = let
    noble-updates-stamp = "20250321T120000Z";
  ...
  in [
    ...
    }
    {
      ...
      packagesFile = (fetchurl {
        ...
        sha256 = "sha256-WtDuyI0wf8KxzCNFtoPwqio5QMAK/YaL/f7uFjQH1A4=";
      });
    ...
    }
    {
      ...
      packagesFile = (fetchurl {
        ...
        sha256 = "sha256-Myrfr+ChTxAiWSyyhVJiF8YmTUvtki6rIpxKPG9wz9c=";
      });
      urlPrefix = "http://snapshot.ubuntu.com/ubuntu/${noble-updates-stamp}";
    }
    {
...
in vmTools.runInLinuxVM (stdenv.mkDerivation {
  ...
  ibis_ros_src = builtins.fetchGit {
    ...
    rev = "5e95b8ec886d1bac3b478057a646c224866a4051";
    submodules = true;
  };
